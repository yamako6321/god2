...
BTU_e = BTU_g/BTU2 #1 gallon ethanol
price = v_g * 3 #in dollars USA
print(f'volume of gasoline in liters: {v_l}')
print(f'barrels of oil: {n_brrls_of_oil}')
print(f'volume of carbon dioxide: {v_CO2}')
print(f'equivalent volume of ethanol (gallons): {BTU_e}')
print(f'price: {price}')